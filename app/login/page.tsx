...
export default function LoginPage() {
  return (
    <div className="w-full min-h-screen grid lg:grid-cols-2 lg:h-screen lg:overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-primary p-12 text-primary-foreground relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md space-y-6">
          <h2 className="font-serif text-4xl leading-[1.1]">
            Clinical-grade skin clarity,{" "}
            <span className="text-accent italic">democratized.</span>
          </h2>
          <p className="text-primary-foreground/80 text-lg leading-relaxed">
            Join thousands of users discovering their unique skin profile
            through our advanced AI analysis engine.
          </p>
        </div>
