...
import { useDebounce } from "@/hooks/use-debounce" // We might need to create this if it doesn't exist, or just use setTimeout
...
export function MultiSelectIngredients({ value = [], onChange }: MultiSelectIngredientsProps) {
                                ...
                                {options.map((ingredient) => (
                                    ...
                                    >
                                        <div className={cn(
                                            ...
                                            value.includes(ingredient.name) ? "bg-primary text-primary-foreground" : "opacity-50 [&_svg]:invisible"
                                        )}>
