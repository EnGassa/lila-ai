...
export function PhotoGuidelines() {
  return (
    <div className="bg-[#F2F0E9] text-[#4A4238] p-6 font-sans min-h-screen">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-medium mb-6">How to Take Photos</h1>
        <div className="bg-[#E6E2D6] p-6 rounded-lg mb-8 border border-[#D6CDBF]">
          ...
          {GUIDELINES.map((guideline, index) => (
            <div key={guideline.id}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                ...
                <p className="text-base font-light leading-relaxed">{guideline.description}</p>
              </div>
            </div>
          ))}
        </div>
