  ...
  const guidelines = [
    {
      ...
      description: (
        <>
          <strong>Look straight at the camera</strong> with a neutral expression
          (mouth closed, not smiling). Click at eye level. Do not focus on a
    ...
    },
    {
      ...
      description: (
        <>
          <strong>Turn your face slightly</strong> so that the camera sees your
          left side at a 45-degree angle. We want to see the cheek and jawline
    ...
    },
    {
      ...
      description: (
        <>
          Same as above, but show the other side of your face.{" "}
          <strong>Turn the other way</strong> so the camera sees your right side
          at 45°.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          <strong>Face front and look up slightly</strong> to capture your chin
          and neck area.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          <strong>Look down and tuck your chin slightly.</strong> We want a
    ...
    },
    {
      ...
      description: (
        <>
          <strong>Take a close up of the left cheek,</strong> make sure the
    ...
    },
    {
      ...
      description: (
        <>
          <strong>Frame such that the under-eye is visible;</strong> basically
          the camera is looking at your face at roughly a 45° that lets the
    ...
    },
    {
      ...
      description: (
        <>
          <strong>Click a close up of the nose.</strong> Tap to focus on the
          nose if needed. The camera will automatically focus on the eyes so
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-8">
          ...
          <ul className="list-disc list-inside text-base font-light mt-4 space-y-2">
            <li>
              <strong>Wash your face with a cleanser</strong>, remove any makeup
              and moisturizer
            </li>
            <li>Tie your hair back, keep face clean and dry</li>
            <li>
              <strong>
                Preferably use your BACK camera for better quality images.
              </strong>{" "}
              If incase that is not possible, you can the front camera.{" "}
            </li>
            <li>
              <strong>Click it indoors </strong> during the day using natural
              light
            </li>
            <li>
              Stand <strong>facing a window in daylight</strong>
            </li>
            <li>
              Avoid direct{" "}
              <strong>harsh sunlight, glares or dark shadows</strong>
            </li>
            <li>
              Disable any <strong>face retouching options or filters</strong>{" "}
              (usually turned off by default for the back camera)
            </li>
          </ul>
        </div>
