...
export async function createUser(
  ...
  try {
    ...
    if (!authData.user) {
      return {
        success: false,
        message: "Use creation failed: No user returned.",
      };
    }
...
export async function updateUser(
  ...
  try {
    ...
    if (authError) {
      ...
      return {
        success: false,
        message: `Auth Update Error: ${authError.message}`,
      };
    }
    ...
    if (profileError) {
      ...
      return {
        success: false,
        message: `Profile Update Error: ${profileError.message}`,
      };
    }
...
export async function deleteUser(
  ...
  try {
    ...
    if (profileError) {
      ...
      return {
        success: false,
        message: `Profile Delete Error: ${profileError.message}`,
      };
    }
    ...
    if (authError) {
      ...
      return {
        success: false,
        message: `Auth Delete Error: ${authError.message}`,
      };
    }
