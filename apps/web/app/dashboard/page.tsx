...
import { enrichBasicProducts } from "@/lib/data-enrichment";
...
export default async function DashboardPage({
  ...
  // Use the shared library function for basic enrichment (names, images)
  await enrichBasicProducts(supabase, recommendationsData);
